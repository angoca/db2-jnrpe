    ...
    public static DB2Versions getDB2Version(final DatabaseConnection dbConn)
        ...
        try {
            ...
            try {
                ...
                int code = DBBroker.getSQLCode(sqle);
            ...
            while (res.next()) {
                ...
                } else if (version_text == DB2Versions.V9_1.getName()) {
                    version = DB2Versions.V9_1;
                } else if (version_text == DB2Versions.V9_5.getName()) {
                    version = DB2Versions.V9_5;
                } else if (version_text == DB2Versions.V9_7.getName()) {
                    version = DB2Versions.V9_7;
                } else if (version_text == DB2Versions.V9_8.getName()) {
                    version = DB2Versions.V9_8;
                } else if (version_text == DB2Versions.V10_1.getName()) {
                    version = DB2Versions.V10_1;
                } else if (version_text == DB2Versions.V10_5.getName()) {
            ...
            DBBroker.processException(sqle);
        }
        return version;
    }
}
